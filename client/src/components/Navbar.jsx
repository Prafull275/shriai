      ...
      >
        <div className="flex items-center gap-3 cursor-pointer">
          <div className="bg-primary text-white p-2 rounded-lg">
            <Link to="https://shriai.vercel.app/">
              <BsRobot size={18} />
            </Link>
          </div>
          <Link to="https://shriai.vercel.app/">
          
            <h1 className="font-semibold hidden md:block text-lg">ShriAi</h1>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-6  relative">
          ...
          <div className="relative">
            <button
              ...
              className="w-9 h-9 bg-primary text-white rounded-full flex items-center justify-center font-semibold"
            >
              {userData ? (
